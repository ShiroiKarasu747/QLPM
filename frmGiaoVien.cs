...
namespace QuanLyPhongMay_newvers
{
    public partial class frmGiaoVien : Form
    {
        ...
        private void LoadDataGridView()
        {
            ...
            DataTable tblTinh = QuanlyPhongMay.Class.Functions.GetDataToTable(sql); //Đọc dữ liệu từ bảng
        ...
        private void btnXoa_Click_1(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("Bạn có muốn xoá không?", "Thông báo", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                ...
                QuanlyPhongMay.Class.Functions.RunSqlDel(sql);
                LoadDataGridView();
                ResetValue();
            }
        }
        ...
        private void btnLuu_Click_1(object sender, EventArgs e)
        {
            ...
            if (QuanlyPhongMay.Class.Functions.CheckKey(sql))
            {
            ...
            QuanlyPhongMay.Class.Functions.RunSQL(sql); //Thực hiện câu lệnh sql
