...
namespace QuanLyPhongMay_newvers
{
    public partial class frmInLichThucHanh : Form
    {
        ...
        {
            DataTable tbl = QuanlyPhongMay.Class.Functions.GetDataToTable("SELECT * FROM tblLichThucHanh");
        ...
        {
            //Load cboMaLop
            cboMaLop.DataSource = QuanlyPhongMay.Class.Functions.GetDataToTable("SELECT DISTINCT  MaLop FROM tblLichThucHanh");
            cboMaLop.ValueMember = "MaLop";
            cboMaLop.DisplayMember = "MaLop";
            cboMaLop.SelectedIndex = -1;
            //Load cboMaGV
            cboMaGV.DataSource = QuanlyPhongMay.Class.Functions.GetDataToTable("SELECT DISTINCT MaGV FROM tblLichThucHanh");
            cboMaGV.ValueMember = "MaGV";
            cboMaGV.DisplayMember = "MaGV";
            cboMaGV.SelectedIndex = -1;
            //Load cboMaPhòng máy
            cboMaPM.DataSource = QuanlyPhongMay.Class.Functions.GetDataToTable("SELECT DISTINCT MaPM FROM tblLichThucHanh");
        ...
        private void btnIn_Click(object sender, EventArgs e)
        {
            ...
            if (cboMaLop.Text != "")
            {
                ...
                tblLichThucHanh = QuanlyPhongMay.Class.Functions.GetDataToTable(sql);
