...
namespace QuanLyPhongMay
{
        ...
        
    {
        ...
        {
            txtMaPhongMay.Text = dgvPhongMay.CurrentRow.Cells["MaPM"].Value.ToString();
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            sql = "UPDATE tblPhongMay SET TenPM =N'" + txtTenPhongMay.Text.ToString() + "',SoMay=N'" + txtSoMay.Text.ToString()
                + "', DiaDiem=N'"+ txtDiaDiem.Text.Trim().ToString() + "' where  MaPM=N'" + txtMaPhongMay.Text + "'" ;
             tbl = QuanlyPhongMay.Class.Functions.GetDataToTable(sql);
            loadDataGridView();
            txtMaPhongMay.Enabled = false;
            txtSoMay.Text = "";
        ...
        private void btnXoa_Click_1(object sender, EventArgs e)
        {
            ...
            if (txtMaPhongMay.Text == "") //nếu chưa chọn cái nào
            {
            ...
            {
                sql = "DELETE tblPhongMay WHERE MaPM =N'" + txtMaPhongMay.Text + "'";
        ...
        private void btnLuu_Click_1(object sender, EventArgs e)
        {
            ...
            {
                string sql = "insert into tblPhongMay values ( '" + txtMaPhongMay.Text.Trim() + "', '" + txtTenPhongMay.Text.Trim()+ "','"
        ...
        private void btnIn_Click(object sender, EventArgs e)
        {
            ...
            sql = "SELECT * from tblMayTinh where MaPM=N'" + txtMaPhongMay.Text + "'";
            tblMayTinh = QuanlyPhongMay.Class.Functions.GetDataToTable(sql);
